...
Namespace TABLE
    'Represents a transaction for TB_MOBILE_APPOINT_ACT table CenLinqDB.
    '[Create by  on October, 18 2013]
    Public Class TbMobileAppointActCenLinqDB
        Public sub TbMobileAppointActCenLinqDB()

        End Sub 
        ' TB_MOBILE_APPOINT_ACT
        Const _tableName As String = "TB_MOBILE_APPOINT_ACT"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_MOBILE_APPOINT_ACT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_MOBILE_APPOINT_ACT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_MOBILE_APPOINT_ACT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_MOBILE_APPOINT_ACT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_MOBILE_APPOINT_ACT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbMobileAppointActCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_MOBILE_APPOINT_ACT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbMobileAppointActCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_MOBILE_APPOINT_ACT by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("action_status")) = False Then _action_status = Rdr("action_status").ToString()
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbMobileAppointActCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_MOBILE_APPOINT_ACT by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbMobileAppointActCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbMobileAppointActCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("action_status")) = False Then ret.action_status = Rdr("action_status").ToString()
        ...
        'Get Insert Statement for table TB_MOBILE_APPOINT_ACT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MOBILE_NO, APP_DATE, SERVICE_ID, SHOP_ID, APPOINTMENT_TIME, ACTION_STATUS)"
                Sql += " VALUES("
                ...
                sql += DB.SetString(_ACTION_STATUS)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table TB_MOBILE_APPOINT_ACT
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ACTION_STATUS = " & DB.SetString(_ACTION_STATUS) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_MOBILE_APPOINT_ACT
        ...
        'Get Select Statement for table TB_MOBILE_APPOINT_ACT
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MOBILE_NO, APP_DATE, SERVICE_ID, SHOP_ID, APPOINTMENT_TIME, ACTION_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
