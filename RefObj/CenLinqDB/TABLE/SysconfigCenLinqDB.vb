...
Namespace TABLE
    'Represents a transaction for SYSCONFIG table CenLinqDB.
    '[Create by  on Febuary, 16 2012]
    Public Class SysconfigCenLinqDB
        Public sub SysconfigCenLinqDB()
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As SysconfigCenLinqDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As SysconfigCenParaDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByCONFIG_NAME(cCONFIG_NAME As String, cid As Integer, trans As SQLTransaction) As Boolean
            Return doChkData("CONFIG_NAME = " & DB.SetString(cCONFIG_NAME) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of SYSCONFIG by specified ROWGUID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of SYSCONFIG by specified ROWGUID key is retrieved successfully.
        '/// <param name=cROWGUID>The ROWGUID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("display_label_th")) = False Then _display_label_th = Rdr("display_label_th").ToString()
                        If Convert.IsDBNull(Rdr("display_label_en")) = False Then _display_label_en = Rdr("display_label_en").ToString()
                        If Convert.IsDBNull(Rdr("desc")) = False Then _desc = Rdr("desc").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As SysconfigCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As SysconfigCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New SysconfigCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("display_label_th")) = False Then ret.display_label_th = Rdr("display_label_th").ToString()
                        If Convert.IsDBNull(Rdr("display_label_en")) = False Then ret.display_label_en = Rdr("display_label_en").ToString()
                        If Convert.IsDBNull(Rdr("desc")) = False Then ret.desc = Rdr("desc").ToString()
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, CONFIG_NAME, CONFIG_VALUE, DISPLAY_LABEL_TH, DISPLAY_LABEL_EN, DESC, ROWGUID)"
                Sql += " VALUES("
                ...
                sql += DB.SetString(_DISPLAY_LABEL_TH) & ", "
                sql += DB.SetString(_DISPLAY_LABEL_EN) & ", "
                sql += DB.SetString(_DESC) & ", "
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "DISPLAY_LABEL_TH = " & DB.SetString(_DISPLAY_LABEL_TH) & ", "
                Sql += "DISPLAY_LABEL_EN = " & DB.SetString(_DISPLAY_LABEL_EN) & ", "
                Sql += "DESC = " & DB.SetString(_DESC) & ", "
