...
Namespace TABLE
    'Represents a transaction for TB_APPOINTMENT_JOB table CenLinqDB.
    '[Create by  on April, 25 2013]
    Public Class TbAppointmentJobCenLinqDB
        Public sub TbAppointmentJobCenLinqDB()

        End Sub 
        ' TB_APPOINTMENT_JOB
        Const _tableName As String = "TB_APPOINTMENT_JOB"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_APPOINTMENT_JOB table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_APPOINTMENT_JOB table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_APPOINTMENT_JOB table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_APPOINTMENT_JOB by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_APPOINTMENT_JOB by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbAppointmentJobCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_APPOINTMENT_JOB by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbAppointmentJobCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_APPOINTMENT_JOB by specified MOBILE_NO key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_APPOINTMENT_JOB by specified MOBILE_NO key is retrieved successfully.
        '/// <param name=cMOBILE_NO>The MOBILE_NO key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_APPOINTMENT_JOB by specified ACTIVE_STATUS_MOBILE_NO_START_SLOT key is retrieved successfully.
        '/// <param name=cACTIVE_STATUS_MOBILE_NO_START_SLOT>The ACTIVE_STATUS_MOBILE_NO_START_SLOT key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByACTIVE_STATUS_MOBILE_NO_START_SLOT(cACTIVE_STATUS As String, cMOBILE_NO As String, cSTART_SLOT As DateTime, trans As SQLTransaction) As Boolean
            Return doChkData("ACTIVE_STATUS = " & DB.SetString(cACTIVE_STATUS) & " AND MOBILE_NO = " & DB.SetString(cMOBILE_NO) & " AND START_SLOT = " & DB.SetDateTime(cSTART_SLOT), trans)
        End Function

        '/// Returns an duplicate data record of TB_APPOINTMENT_JOB by specified ACTIVE_STATUS_MOBILE_NO_START_SLOT key is retrieved successfully.
        '/// <param name=cACTIVE_STATUS_MOBILE_NO_START_SLOT>The ACTIVE_STATUS_MOBILE_NO_START_SLOT key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByACTIVE_STATUS_MOBILE_NO_START_SLOT(cACTIVE_STATUS As String, cMOBILE_NO As String, cSTART_SLOT As DateTime, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("ACTIVE_STATUS = " & DB.SetString(cACTIVE_STATUS) & " AND MOBILE_NO = " & DB.SetString(cMOBILE_NO) & " AND START_SLOT = " & DB.SetDateTime(cSTART_SLOT) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_APPOINTMENT_JOB by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbAppointmentJobCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_APPOINTMENT_JOB by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbAppointmentJobCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbAppointmentJobCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_APPOINTMENT_JOB
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ABB, MOBILE_NO, APP_DATE, START_SLOT, APPOINTMENT_CHANNEL, ACTIVE_STATUS)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_APPOINTMENT_JOB
        ...
        'Get Delete Record in table TB_APPOINTMENT_JOB
        ...
        'Get Select Statement for table TB_APPOINTMENT_JOB
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ABB, MOBILE_NO, APP_DATE, START_SLOT, APPOINTMENT_CHANNEL, ACTIVE_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
