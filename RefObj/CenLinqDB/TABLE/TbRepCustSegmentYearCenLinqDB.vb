...
Namespace TABLE
    'Represents a transaction for TB_REP_CUST_SEGMENT_YEAR table CenLinqDB.
    '[Create by  on April, 17 2012]
    Public Class TbRepCustSegmentYearCenLinqDB
        Public sub TbRepCustSegmentYearCenLinqDB()

        End Sub 
        ' TB_REP_CUST_SEGMENT_YEAR
        Const _tableName As String = "TB_REP_CUST_SEGMENT_YEAR"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_CUST_SEGMENT_YEAR table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_CUST_SEGMENT_YEAR table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_CUST_SEGMENT_YEAR table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_CUST_SEGMENT_YEAR by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_CUST_SEGMENT_YEAR by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As TbRepCustSegmentYearCenLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_CUST_SEGMENT_YEAR by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As TbRepCustSegmentYearCenParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_CUST_SEGMENT_YEAR by specified SHOW_QUARTER_SHOW_YEAR key is retrieved successfully.
        '/// <param name=cSHOW_QUARTER_SHOW_YEAR>The SHOW_QUARTER_SHOW_YEAR key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataBySHOW_QUARTER_SHOW_YEAR(cSHOW_QUARTER As Integer, cSHOW_YEAR As Integer, trans As SQLTransaction) As Boolean
            Return doChkData("SHOW_QUARTER = " & DB.SetDouble(cSHOW_QUARTER) & " AND SHOW_YEAR = " & DB.SetDouble(cSHOW_YEAR), trans)
        End Function

        '/// Returns an duplicate data record of TB_REP_CUST_SEGMENT_YEAR by specified SHOW_QUARTER_SHOW_YEAR key is retrieved successfully.
        '/// <param name=cSHOW_QUARTER_SHOW_YEAR>The SHOW_QUARTER_SHOW_YEAR key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateBySHOW_QUARTER_SHOW_YEAR(cSHOW_QUARTER As Integer, cSHOW_YEAR As Integer, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("SHOW_QUARTER = " & DB.SetDouble(cSHOW_QUARTER) & " AND SHOW_YEAR = " & DB.SetDouble(cSHOW_YEAR) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_CUST_SEGMENT_YEAR by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepCustSegmentYearCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_CUST_SEGMENT_YEAR by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepCustSegmentYearCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepCustSegmentYearCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_REP_CUST_SEGMENT_YEAR
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SHOW_QUARTER, SHOW_YEAR, DATA_COLUMN, DATA_VALUE)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_REP_CUST_SEGMENT_YEAR
        ...
        'Get Delete Record in table TB_REP_CUST_SEGMENT_YEAR
        ...
        'Get Select Statement for table TB_REP_CUST_SEGMENT_YEAR
