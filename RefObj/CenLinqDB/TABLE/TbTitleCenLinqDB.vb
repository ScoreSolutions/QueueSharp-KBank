...
Namespace TABLE
    'Represents a transaction for TB_TITLE table CenLinqDB.
    '[Create by  on June, 26 2013]
    Public Class TbTitleCenLinqDB
        Public sub TbTitleCenLinqDB()
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_TITLE_CODE", DbType:="VarChar(50) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbTitleCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_TITLE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbTitleCenParaDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByTITLE_CODE(cTITLE_CODE As String, trans As SQLTransaction) As Boolean
            Return doChkData("TITLE_CODE = " & DB.SetString(cTITLE_CODE) & " ", trans)
        End Function

        '/// Returns an duplicate data record of TB_TITLE by specified TITLE_CODE key is retrieved successfully.
        '/// <param name=cTITLE_CODE>The TITLE_CODE key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByTITLE_CODE(cTITLE_CODE As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("TITLE_CODE = " & DB.SetString(cTITLE_CODE) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByTITLE_NAME(cTITLE_NAME As String, trans As SQLTransaction) As Boolean
            Return doChkData("TITLE_NAME = " & DB.SetString(cTITLE_NAME) & " ", trans)
        End Function

        '/// Returns an duplicate data record of TB_TITLE by specified TITLE_NAME key is retrieved successfully.
        '/// <param name=cTITLE_NAME>The TITLE_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByTITLE_NAME(cTITLE_NAME As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("TITLE_NAME = " & DB.SetString(cTITLE_NAME) & " " & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbTitleCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbTitleCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbTitleCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TITLE_CODE, TITLE_NAME)"
                Sql += " VALUES("
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TITLE_CODE, TITLE_NAME FROM " & tableName
                Return Sql
            End Get
        End Property
