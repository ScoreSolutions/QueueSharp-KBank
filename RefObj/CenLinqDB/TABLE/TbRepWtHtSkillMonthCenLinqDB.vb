...
Namespace TABLE
    'Represents a transaction for TB_REP_WT_HT_SKILL_MONTH table CenLinqDB.
    '[Create by  on March, 22 2013]
    Public Class TbRepWtHtSkillMonthCenLinqDB
        Public sub TbRepWtHtSkillMonthCenLinqDB()

        End Sub 
        ' TB_REP_WT_HT_SKILL_MONTH
        Const _tableName As String = "TB_REP_WT_HT_SKILL_MONTH"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_WT_HT_SKILL_MONTH table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_WT_HT_SKILL_MONTH table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_WT_HT_SKILL_MONTH table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_WT_HT_SKILL_MONTH by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_WT_HT_SKILL_MONTH by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbRepWtHtSkillMonthCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_WT_HT_SKILL_MONTH by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbRepWtHtSkillMonthCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_WT_HT_SKILL_MONTH by specified MONTH_NO_SHOP_ID_SHOW_YEAR key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_REP_WT_HT_SKILL_MONTH by specified MONTH_NO_SHOP_ID_SHOW_YEAR key is retrieved successfully.
        '/// <param name=cMONTH_NO_SHOP_ID_SHOW_YEAR>The MONTH_NO_SHOP_ID_SHOW_YEAR key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_REP_WT_HT_SKILL_MONTH by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("num_of_queue")) = False Then _num_of_queue = Convert.ToInt32(Rdr("num_of_queue"))
                        ...
                        If Convert.IsDBNull(Rdr("miss_call")) = False Then _miss_call = Convert.ToInt32(Rdr("miss_call"))
                        ...
                        If Convert.IsDBNull(Rdr("awt")) = False Then _awt = Rdr("awt").ToString()
                        ...
                        If Convert.IsDBNull(Rdr("aht")) = False Then _aht = Rdr("aht").ToString()
                        ...
                        If Convert.IsDBNull(Rdr("acont")) = False Then _acont = Rdr("acont").ToString()
                        If Convert.IsDBNull(Rdr("sum_cont")) = False Then _sum_cont = Convert.ToInt64(Rdr("sum_cont"))
                        If Convert.IsDBNull(Rdr("count_cont")) = False Then _count_cont = Convert.ToInt32(Rdr("count_cont"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepWtHtSkillMonthCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_WT_HT_SKILL_MONTH by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepWtHtSkillMonthCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepWtHtSkillMonthCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("num_of_queue")) = False Then ret.num_of_queue = Convert.ToInt32(Rdr("num_of_queue"))
                        ...
                        If Convert.IsDBNull(Rdr("miss_call")) = False Then ret.miss_call = Convert.ToInt32(Rdr("miss_call"))
                        ...
                        If Convert.IsDBNull(Rdr("awt")) = False Then ret.awt = Rdr("awt").ToString()
                        ...
                        If Convert.IsDBNull(Rdr("aht")) = False Then ret.aht = Rdr("aht").ToString()
                        ...
                        If Convert.IsDBNull(Rdr("acont")) = False Then ret.acont = Rdr("acont").ToString()
                        If Convert.IsDBNull(Rdr("sum_cont")) = False Then ret.sum_cont = Convert.ToInt64(Rdr("sum_cont"))
                        If Convert.IsDBNull(Rdr("count_cont")) = False Then ret.count_cont = Convert.ToInt32(Rdr("count_cont"))
        ...
        'Get Insert Statement for table TB_REP_WT_HT_SKILL_MONTH
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, MONTH_NO, SHOW_MONTH, SHOW_YEAR, USER_CODE, STAFF_NAME, SKILL_ID, SKILL_NAME, NUM_OF_QUEUE, REGIS, SERVE, MISS_CALL, CANCEL, NOT_CALL, NOT_CON, NOT_END, AWT, SUM_WT, COUNT_WT, AHT, SUM_HT, COUNT_HT, ACONT, SUM_CONT, COUNT_CONT)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_NUM_OF_QUEUE) & ", "
        ...
        'Get update statement form table TB_REP_WT_HT_SKILL_MONTH
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "NUM_OF_QUEUE = " & DB.SetDouble(_NUM_OF_QUEUE) & ", "
        ...
        'Get Delete Record in table TB_REP_WT_HT_SKILL_MONTH
        ...
        'Get Select Statement for table TB_REP_WT_HT_SKILL_MONTH
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, MONTH_NO, SHOW_MONTH, SHOW_YEAR, USER_CODE, STAFF_NAME, SKILL_ID, SKILL_NAME, NUM_OF_QUEUE, REGIS, SERVE, MISS_CALL, CANCEL, NOT_CALL, NOT_CON, NOT_END, AWT, SUM_WT, COUNT_WT, AHT, SUM_HT, COUNT_HT, ACONT, SUM_CONT, COUNT_CONT FROM " & tableName
                Return Sql
            End Get
        End Property
