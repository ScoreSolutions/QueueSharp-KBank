...
Namespace TABLE
    'Represents a transaction for TB_REP_PRODUCTIVITY_MONTH table CenLinqDB.
    '[Create by  on March, 11 2013]
    Public Class TbRepProductivityMonthCenLinqDB
        Public sub TbRepProductivityMonthCenLinqDB()

        End Sub 
        ' TB_REP_PRODUCTIVITY_MONTH
        Const _tableName As String = "TB_REP_PRODUCTIVITY_MONTH"
        ...
        Public Property MONTH_NO() As Long
            ...
            End Set
        End Property 
        <Column(Storage:="_SHOW_MONTH", DbType:="VarChar(100) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_PRODUCTIVITY_MONTH table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_PRODUCTIVITY_MONTH table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_PRODUCTIVITY_MONTH table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_PRODUCTIVITY_MONTH by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_PRODUCTIVITY_MONTH by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbRepProductivityMonthCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_PRODUCTIVITY_MONTH by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbRepProductivityMonthCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_PRODUCTIVITY_MONTH by specified MONTH_NO_SHOP_ID_SHOW_YEAR key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_REP_PRODUCTIVITY_MONTH by specified MONTH_NO_SHOP_ID_SHOW_YEAR key is retrieved successfully.
        '/// <param name=cMONTH_NO_SHOP_ID_SHOW_YEAR>The MONTH_NO_SHOP_ID_SHOW_YEAR key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_REP_PRODUCTIVITY_MONTH by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("total_target")) = False Then _total_target = Convert.ToInt32(Rdr("total_target"))
                        If Convert.IsDBNull(Rdr("total_actual")) = False Then _total_actual = Convert.ToInt32(Rdr("total_actual"))
                        If Convert.IsDBNull(Rdr("total_per_achieve_target")) = False Then _total_per_achieve_target = Convert.ToInt32(Rdr("total_per_achieve_target"))
                        If Convert.IsDBNull(Rdr("total_aht")) = False Then _total_aht = Convert.ToInt32(Rdr("total_aht"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepProductivityMonthCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_PRODUCTIVITY_MONTH by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepProductivityMonthCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepProductivityMonthCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("total_target")) = False Then ret.total_target = Convert.ToInt32(Rdr("total_target"))
                        If Convert.IsDBNull(Rdr("total_actual")) = False Then ret.total_actual = Convert.ToInt32(Rdr("total_actual"))
                        If Convert.IsDBNull(Rdr("total_per_achieve_target")) = False Then ret.total_per_achieve_target = Convert.ToInt32(Rdr("total_per_achieve_target"))
                        If Convert.IsDBNull(Rdr("total_aht")) = False Then ret.total_aht = Convert.ToInt32(Rdr("total_aht"))
        ...
        'Get Insert Statement for table TB_REP_PRODUCTIVITY_MONTH
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, USER_ID, USER_CODE, USER_NAME, STAFF_NAME, MONTH_NO, SHOW_MONTH, SHOW_YEAR, TOTAL_TARGET, TOTAL_ACTUAL, TOTAL_PER_ACHIEVE_TARGET, TOTAL_AHT, DATA_VALUE)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_TOTAL_TARGET) & ", "
                sql += DB.SetDouble(_TOTAL_ACTUAL) & ", "
                sql += DB.SetDouble(_TOTAL_PER_ACHIEVE_TARGET) & ", "
                sql += DB.SetDouble(_TOTAL_AHT) & ", "
        ...
        'Get update statement form table TB_REP_PRODUCTIVITY_MONTH
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "TOTAL_TARGET = " & DB.SetDouble(_TOTAL_TARGET) & ", "
                Sql += "TOTAL_ACTUAL = " & DB.SetDouble(_TOTAL_ACTUAL) & ", "
                Sql += "TOTAL_PER_ACHIEVE_TARGET = " & DB.SetDouble(_TOTAL_PER_ACHIEVE_TARGET) & ", "
                Sql += "TOTAL_AHT = " & DB.SetDouble(_TOTAL_AHT) & ", "
        ...
        'Get Delete Record in table TB_REP_PRODUCTIVITY_MONTH
        ...
        'Get Select Statement for table TB_REP_PRODUCTIVITY_MONTH
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, USER_ID, USER_CODE, USER_NAME, STAFF_NAME, MONTH_NO, SHOW_MONTH, SHOW_YEAR, TOTAL_TARGET, TOTAL_ACTUAL, TOTAL_PER_ACHIEVE_TARGET, TOTAL_AHT, DATA_VALUE FROM " & tableName
                Return Sql
            End Get
        End Property
