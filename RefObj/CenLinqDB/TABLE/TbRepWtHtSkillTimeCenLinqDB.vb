...
Namespace TABLE
    'Represents a transaction for TB_REP_WT_HT_SKILL_TIME table CenLinqDB.
    '[Create by  on March, 21 2013]
    Public Class TbRepWtHtSkillTimeCenLinqDB
        Public sub TbRepWtHtSkillTimeCenLinqDB()

        End Sub 
        ' TB_REP_WT_HT_SKILL_TIME
        Const _tableName As String = "TB_REP_WT_HT_SKILL_TIME"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_WT_HT_SKILL_TIME table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_WT_HT_SKILL_TIME table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_WT_HT_SKILL_TIME table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_WT_HT_SKILL_TIME by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_WT_HT_SKILL_TIME by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbRepWtHtSkillTimeCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_WT_HT_SKILL_TIME by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbRepWtHtSkillTimeCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_WT_HT_SKILL_TIME by specified INTERVAL_MINUTE_SERVICE_DATE_SHOP_ID key is retrieved successfully.
        '/// <param name=cINTERVAL_MINUTE_SERVICE_DATE_SHOP_ID>The INTERVAL_MINUTE_SERVICE_DATE_SHOP_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByINTERVAL_MINUTE_SERVICE_DATE_SHOP_ID(cINTERVAL_MINUTE As Integer, cSERVICE_DATE As DateTime, cSHOP_ID As Integer, trans As SQLTransaction) As Boolean
            Return doChkData("INTERVAL_MINUTE = " & DB.SetDouble(cINTERVAL_MINUTE) & " AND SERVICE_DATE = " & DB.SetDateTime(cSERVICE_DATE) & " AND SHOP_ID = " & DB.SetDouble(cSHOP_ID), trans)
        End Function

        '/// Returns an duplicate data record of TB_REP_WT_HT_SKILL_TIME by specified INTERVAL_MINUTE_SERVICE_DATE_SHOP_ID key is retrieved successfully.
        '/// <param name=cINTERVAL_MINUTE_SERVICE_DATE_SHOP_ID>The INTERVAL_MINUTE_SERVICE_DATE_SHOP_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByINTERVAL_MINUTE_SERVICE_DATE_SHOP_ID(cINTERVAL_MINUTE As Integer, cSERVICE_DATE As DateTime, cSHOP_ID As Integer, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("INTERVAL_MINUTE = " & DB.SetDouble(cINTERVAL_MINUTE) & " AND SERVICE_DATE = " & DB.SetDateTime(cSERVICE_DATE) & " AND SHOP_ID = " & DB.SetDouble(cSHOP_ID) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_WT_HT_SKILL_TIME by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("skill_id")) = False Then _skill_id = Convert.ToInt32(Rdr("skill_id"))
                        If Convert.IsDBNull(Rdr("skill_name")) = False Then _skill_name = Rdr("skill_name").ToString()
                        ...
                        If Convert.IsDBNull(Rdr("wt")) = False Then _wt = Rdr("wt").ToString()
                        If Convert.IsDBNull(Rdr("ht")) = False Then _ht = Rdr("ht").ToString()
                        If Convert.IsDBNull(Rdr("cont")) = False Then _cont = Rdr("cont").ToString()
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepWtHtSkillTimeCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_WT_HT_SKILL_TIME by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepWtHtSkillTimeCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepWtHtSkillTimeCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("skill_id")) = False Then ret.skill_id = Convert.ToInt32(Rdr("skill_id"))
                        If Convert.IsDBNull(Rdr("skill_name")) = False Then ret.skill_name = Rdr("skill_name").ToString()
                        ...
                        If Convert.IsDBNull(Rdr("wt")) = False Then ret.wt = Rdr("wt").ToString()
                        If Convert.IsDBNull(Rdr("ht")) = False Then ret.ht = Rdr("ht").ToString()
                        If Convert.IsDBNull(Rdr("cont")) = False Then ret.cont = Rdr("cont").ToString()
        ...
        'Get Insert Statement for table TB_REP_WT_HT_SKILL_TIME
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SERVICE_DATE, SHOW_DATE, USER_CODE, STAFF_NAME, SKILL_ID, SKILL_NAME, QUEUE_NO, MOBILE_NO, INTERVAL_MINUTE, SHOW_TIME, WT, HT, CONT)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_SKILL_ID) & ", "
                sql += DB.SetString(_SKILL_NAME) & ", "
                sql += DB.SetString(_QUEUE_NO) & ", "
                sql += DB.SetString(_MOBILE_NO) & ", "
                sql += DB.SetDouble(_INTERVAL_MINUTE) & ", "
                sql += DB.SetString(_SHOW_TIME) & ", "
                sql += DB.SetString(_WT) & ", "
                sql += DB.SetString(_HT) & ", "
                sql += DB.SetString(_CONT)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table TB_REP_WT_HT_SKILL_TIME
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "SKILL_ID = " & DB.SetDouble(_SKILL_ID) & ", "
                Sql += "SKILL_NAME = " & DB.SetString(_SKILL_NAME) & ", "
                ...
                Sql += "WT = " & DB.SetString(_WT) & ", "
                Sql += "HT = " & DB.SetString(_HT) & ", "
                Sql += "CONT = " & DB.SetString(_CONT) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_REP_WT_HT_SKILL_TIME
        ...
        'Get Select Statement for table TB_REP_WT_HT_SKILL_TIME
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SERVICE_DATE, SHOW_DATE, USER_CODE, STAFF_NAME, SKILL_ID, SKILL_NAME, QUEUE_NO, MOBILE_NO, INTERVAL_MINUTE, SHOW_TIME, WT, HT, CONT FROM " & tableName
                Return Sql
            End Get
        End Property
