    ...
    Public Class TwFilterDataCenLinqDB
       ...
       'Define Public Method 
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TW_LOCATION_ID, SERVICE_DATE, ORDER_NO, ORDER_TYPE_NAME, ORDER_UNIQUE_ID, MOBILE_NO, CUSTOMER_NAME, CUSTOMER_SEGMENT, NETWORK_TYPE, USERNAME, TW_FILTER_ID, TW_SFF_ORDER_TYPE_ID, TEMPLATE_CODE, END_TIME, FILTER_TIME, SEND_TIME, ATSR_CALL_TIME, RESULT_TIME, RESULT_STATUS, RESULT, NPS_SCORE, ACTIVITY_ID_SURVEY, ACTIVITY_ID_LEAVE_VOICE FROM " & tableName
                Return Sql
            End Get
        End Property
