...
Namespace TABLE
    'Represents a transaction for TB_SHOP_CONFIG table CenLinqDB.
    '[Create by  on April, 12 2012]
    Public Class TbShopConfigCenLinqDB
        Public sub TbShopConfigCenLinqDB()

        End Sub 
        ' TB_SHOP_CONFIG
        Const _tableName As String = "TB_SHOP_CONFIG"
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_CONFIG_PAGE", DbType:="VarChar(255) NOT NULL ",CanBeNull:=false)>  _
        Public Property CONFIG_PAGE() As String
            Get
                Return _CONFIG_PAGE
            End Get
            Set(ByVal value As String)
            ...
            End Set
        End Property 
        <Column(Storage:="_CONFIG_NAME", DbType:="VarChar(255) NOT NULL ",CanBeNull:=false)>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_SHOP_CONFIG table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_SHOP_CONFIG table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_SHOP_CONFIG table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_SHOP_CONFIG by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_SHOP_CONFIG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As TbShopConfigCenLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_SHOP_CONFIG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As TbShopConfigCenParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_SHOP_CONFIG by specified CONFIG_NAME key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_SHOP_CONFIG by specified CONFIG_NAME key is retrieved successfully.
        '/// <param name=cCONFIG_NAME>The CONFIG_NAME key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_SHOP_CONFIG by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("config_page")) = False Then _config_page = Rdr("config_page").ToString()
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbShopConfigCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_SHOP_CONFIG by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbShopConfigCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbShopConfigCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("config_page")) = False Then ret.config_page = Rdr("config_page").ToString()
        ...
        'Get Insert Statement for table TB_SHOP_CONFIG
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, CONFIG_PAGE, CONFIG_NAME, CONFIG_VALUE, SHOP_ID, EVENT_DATE, ACTIVE)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_SHOP_CONFIG
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "CONFIG_PAGE = " & DB.SetString(_CONFIG_PAGE) & ", "
        ...
        'Get Delete Record in table TB_SHOP_CONFIG
        ...
        'Get Select Statement for table TB_SHOP_CONFIG
