...
Namespace TABLE
    'Represents a transaction for TB_REP_SUMMARY_DAILY_REPORT table CenLinqDB.
    '[Create by  on August, 13 2013]
    Public Class TbRepSummaryDailyReportCenLinqDB
        Public sub TbRepSummaryDailyReportCenLinqDB()

        End Sub 
        ' TB_REP_SUMMARY_DAILY_REPORT
        Const _tableName As String = "TB_REP_SUMMARY_DAILY_REPORT"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_SUMMARY_DAILY_REPORT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_SUMMARY_DAILY_REPORT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_SUMMARY_DAILY_REPORT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_SUMMARY_DAILY_REPORT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_SUMMARY_DAILY_REPORT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbRepSummaryDailyReportCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_SUMMARY_DAILY_REPORT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbRepSummaryDailyReportCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_SUMMARY_DAILY_REPORT by specified NETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY key is retrieved successfully.
        '/// <param name=cNETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY>The NETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByNETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY(cNETWORK_TYPE As String, cSEGMENT_TYPE As String, cSERVICE_DATE As DateTime, cSHOP_LOCATION_GROUP As String, cSHOW_DAY As String, trans As SQLTransaction) As Boolean
            Return doChkData("NETWORK_TYPE = " & DB.SetString(cNETWORK_TYPE) & " AND SEGMENT_TYPE = " & DB.SetString(cSEGMENT_TYPE) & " AND SERVICE_DATE = " & DB.SetDateTime(cSERVICE_DATE) & " AND SHOP_LOCATION_GROUP = " & DB.SetString(cSHOP_LOCATION_GROUP) & " AND SHOW_DAY = " & DB.SetString(cSHOW_DAY), trans)
        End Function

        '/// Returns an duplicate data record of TB_REP_SUMMARY_DAILY_REPORT by specified NETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY key is retrieved successfully.
        '/// <param name=cNETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY>The NETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByNETWORK_TYPE_SEGMENT_TYPE_SERVICE_DATE_SHOP_LOCATION_GROUP_SHOW_DAY(cNETWORK_TYPE As String, cSEGMENT_TYPE As String, cSERVICE_DATE As DateTime, cSHOP_LOCATION_GROUP As String, cSHOW_DAY As String, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("NETWORK_TYPE = " & DB.SetString(cNETWORK_TYPE) & " AND SEGMENT_TYPE = " & DB.SetString(cSEGMENT_TYPE) & " AND SERVICE_DATE = " & DB.SetDateTime(cSERVICE_DATE) & " AND SHOP_LOCATION_GROUP = " & DB.SetString(cSHOP_LOCATION_GROUP) & " AND SHOW_DAY = " & DB.SetString(cSHOW_DAY) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_SUMMARY_DAILY_REPORT by specified SERVICE_DATE_SHOP_ID key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_REP_SUMMARY_DAILY_REPORT by specified SERVICE_DATE_SHOP_ID key is retrieved successfully.
        '/// <param name=cSERVICE_DATE_SHOP_ID>The SERVICE_DATE_SHOP_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_REP_SUMMARY_DAILY_REPORT by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepSummaryDailyReportCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_SUMMARY_DAILY_REPORT by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepSummaryDailyReportCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepSummaryDailyReportCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get update statement form table TB_REP_SUMMARY_DAILY_REPORT
        ...
        'Get Delete Record in table TB_REP_SUMMARY_DAILY_REPORT
        ...
        'Get Select Statement for table TB_REP_SUMMARY_DAILY_REPORT
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SHOP_LOCATION_GROUP, SERVICE_DATE, SHOW_DATE, SHOW_DAY, NETWORK_TYPE, SEGMENT_TYPE, ITEM_ID, ITEM_NAME_EN, ITEM_NAME_TH, REGIS, SERVE, MISSED_CALL, CANCLE, WAIT_WITH_KPI, SERVE_WITH_KPI, AWT, AHT, COUNT_WT, SUM_WT, COUNT_HT, SUM_HT FROM " & tableName
                Return Sql
            End Get
        End Property
