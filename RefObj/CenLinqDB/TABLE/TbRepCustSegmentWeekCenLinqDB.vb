...
Namespace TABLE
    'Represents a transaction for TB_REP_CUST_SEGMENT_WEEK table CenLinqDB.
    '[Create by  on March, 9 2013]
    Public Class TbRepCustSegmentWeekCenLinqDB
        Public sub TbRepCustSegmentWeekCenLinqDB()

        End Sub 
        ' TB_REP_CUST_SEGMENT_WEEK
        Const _tableName As String = "TB_REP_CUST_SEGMENT_WEEK"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_CUST_SEGMENT_WEEK table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_CUST_SEGMENT_WEEK table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_CUST_SEGMENT_WEEK table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_CUST_SEGMENT_WEEK by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_CUST_SEGMENT_WEEK by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbRepCustSegmentWeekCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_CUST_SEGMENT_WEEK by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbRepCustSegmentWeekCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_CUST_SEGMENT_WEEK by specified SHOP_ID_SHOW_YEAR_WEEK_OF_YEAR key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_REP_CUST_SEGMENT_WEEK by specified SHOP_ID_SHOW_YEAR_WEEK_OF_YEAR key is retrieved successfully.
        '/// <param name=cSHOP_ID_SHOW_YEAR_WEEK_OF_YEAR>The SHOP_ID_SHOW_YEAR_WEEK_OF_YEAR key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_REP_CUST_SEGMENT_WEEK by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepCustSegmentWeekCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_CUST_SEGMENT_WEEK by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepCustSegmentWeekCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepCustSegmentWeekCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_REP_CUST_SEGMENT_WEEK
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SHOW_YEAR, WEEK_OF_YEAR, PERIOD_DATE, SERVICE_ID, SERVICE_NAME_EN, SERVICE_NAME_TH, MASS_REGIS, MASS_SERVE, MASS_MISS_CALL, MASS_CANCEL, MASS_INCOMPLETE, SERENADE_REGIS, SERENADE_SERVE, SERENADE_MISS_CALL, SERENADE_CANCEL, SERENADE_INCOMPLETE)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_REP_CUST_SEGMENT_WEEK
        ...
        'Get Delete Record in table TB_REP_CUST_SEGMENT_WEEK
        ...
        'Get Select Statement for table TB_REP_CUST_SEGMENT_WEEK
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SHOW_YEAR, WEEK_OF_YEAR, PERIOD_DATE, SERVICE_ID, SERVICE_NAME_EN, SERVICE_NAME_TH, MASS_REGIS, MASS_SERVE, MASS_MISS_CALL, MASS_CANCEL, MASS_INCOMPLETE, SERENADE_REGIS, SERENADE_SERVE, SERENADE_MISS_CALL, SERENADE_CANCEL, SERENADE_INCOMPLETE FROM " & tableName
                Return Sql
            End Get
        End Property
