...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_TIME table CenLinqDB.
    '[Create by  on May, 31 2012]
    Public Class TbRepAvgServiceTimeKpiTimeCenLinqDB
        Public Sub TbRepAvgServiceTimeKpiTimeCenLinqDB()

        End Sub
        ' TB_REP_AVG_SERVICE_TIME_KPI_TIME
        Const _tableName As String = "TB_REP_AVG_SERVICE_TIME_KPI_TIME"
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_AVG_SERVICE_TIME_KPI_TIME table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_AVG_SERVICE_TIME_KPI_TIME table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_AVG_SERVICE_TIME_KPI_TIME table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_TIME by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_AVG_SERVICE_TIME_KPI_TIME by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(ByVal cid As Long, ByVal trans As SQLTransaction) As TbRepAvgServiceTimeKpiTimeCenLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_AVG_SERVICE_TIME_KPI_TIME by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(ByVal cid As Long, ByVal trans As SQLTransaction) As TbRepAvgServiceTimeKpiTimeCenParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_TIME by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(ByVal whText As String, ByVal trans As SQLTransaction) As TbRepAvgServiceTimeKpiTimeCenLinqDB
            ClearData()
            _haveData = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_AVG_SERVICE_TIME_KPI_TIME by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(ByVal whText As String, ByVal trans As SQLTransaction) As TbRepAvgServiceTimeKpiTimeCenParaDB
            ClearData()
            _haveData = False
            Dim ret As New TbRepAvgServiceTimeKpiTimeCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_REP_AVG_SERVICE_TIME_KPI_TIME
        Private ReadOnly Property SqlInsert() As String
            Get
                Dim Sql As String = ""
                Sql += "INSERT INTO " & TableName & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SERVICE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SERVICE_ID, SERVICE_NAME, INTERVAL_MINUTE, TIME_PRIOD_FROM, TIME_PRIOD_TO, SHOW_TIME, REGIS, SERVED, MISSED_CALL, CANCEL, SERVE_WITH_KPI, WAIT_WITH_KPI, MAX_WT, MAX_HT, NOT_CALL, NOT_CON, NOT_END,ACONT,SCONT,CCONT)"
                Sql += " VALUES("
                ...
                Sql += DB.SetString(_NOTCALL) & ", "
                Sql += DB.SetString(_NOTCON) & ", "
                Sql += DB.SetString(_NOTEND) & ", "
        ...
        'Get update statement form table TB_REP_AVG_SERVICE_TIME_KPI_TIME
        ...
        'Get Delete Record in table TB_REP_AVG_SERVICE_TIME_KPI_TIME
        ...
        'Get Select Statement for table TB_REP_AVG_SERVICE_TIME_KPI_TIME
