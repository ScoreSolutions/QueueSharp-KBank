...
Namespace TABLE
    'Represents a transaction for TB_CFG_USER table CenLinqDB.
    '[Create by  on July, 13 2013]
    Public Class TbCfgUserCenLinqDB
        Public sub TbCfgUserCenLinqDB()

        End Sub 
        ' TB_CFG_USER
        Const _tableName As String = "TB_CFG_USER"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_CFG_USER table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_CFG_USER table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_CFG_USER table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_CFG_USER by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_CFG_USER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbCfgUserCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_CFG_USER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbCfgUserCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_CFG_USER by specified EVENT_DATE_EVENT_STATUS_SHOP_ID key is retrieved successfully.
        '/// <param name=cEVENT_DATE_EVENT_STATUS_SHOP_ID>The EVENT_DATE_EVENT_STATUS_SHOP_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDataByEVENT_DATE_EVENT_STATUS_SHOP_ID(cEVENT_DATE As DateTime, cEVENT_STATUS As String, cSHOP_ID As Integer, trans As SQLTransaction) As Boolean
            Return doChkData("EVENT_DATE = " & DB.SetDateTime(cEVENT_DATE) & " AND EVENT_STATUS = " & DB.SetString(cEVENT_STATUS) & " AND SHOP_ID = " & DB.SetDouble(cSHOP_ID), trans)
        End Function

        '/// Returns an duplicate data record of TB_CFG_USER by specified EVENT_DATE_EVENT_STATUS_SHOP_ID key is retrieved successfully.
        '/// <param name=cEVENT_DATE_EVENT_STATUS_SHOP_ID>The EVENT_DATE_EVENT_STATUS_SHOP_ID key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function ChkDuplicateByEVENT_DATE_EVENT_STATUS_SHOP_ID(cEVENT_DATE As DateTime, cEVENT_STATUS As String, cSHOP_ID As Integer, cid As Long, trans As SQLTransaction) As Boolean
            Return doChkData("EVENT_DATE = " & DB.SetDateTime(cEVENT_DATE) & " AND EVENT_STATUS = " & DB.SetString(cEVENT_STATUS) & " AND SHOP_ID = " & DB.SetDouble(cSHOP_ID) & " And id <> " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_CFG_USER by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbCfgUserCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_CFG_USER by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbCfgUserCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbCfgUserCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_CFG_USER
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, EVENT_DATE, TITLE_ID, USER_CODE, FNAME, LNAME, POSITION, GROUP_ID, USERNAME, PASSWORD, ACTIVE_STATUS, EVENT_STATUS)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_CFG_USER
        ...
        'Get Delete Record in table TB_CFG_USER
        ...
        'Get Select Statement for table TB_CFG_USER
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, EVENT_DATE, TITLE_ID, USER_CODE, FNAME, LNAME, POSITION, GROUP_ID, USERNAME, PASSWORD, ACTIVE_STATUS, EVENT_STATUS FROM " & tableName
                Return Sql
            End Get
        End Property
       ...
       Dim _TB_CFG_USER_SKILL_tb_cfg_user_id As DataTable

       Public Property CHILD_TB_CFG_USER_SKILL_tb_cfg_user_id() As DataTable
           Get
               'Child Table Name : TB_CFG_USER_SKILL Column :tb_cfg_user_id
               Dim trans As New CenLinqDB.Common.Utilities.TransactionDB
               Dim TbCfgUserSkillItem As New TbCfgUserSkillCenLinqDB
               _TB_CFG_USER_SKILL_tb_cfg_user_id = TbCfgUserSkillItem.GetDataList("tb_cfg_user_id = " & _ID, "", trans.Trans)
               trans.CommitTransaction()
               TbCfgUserSkillItem = Nothing
               Return _TB_CFG_USER_SKILL_tb_cfg_user_id
           End Get
           Set(ByVal value As DataTable)
               _TB_CFG_USER_SKILL_tb_cfg_user_id = value
           End Set
       End Property
    End Class
End Namespace
