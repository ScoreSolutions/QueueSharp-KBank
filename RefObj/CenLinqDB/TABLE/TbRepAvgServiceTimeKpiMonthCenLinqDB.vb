...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_MONTH table CenLinqDB.
    '[Create by  on March, 8 2013]
    Public Class TbRepAvgServiceTimeKpiMonthCenLinqDB
        Public sub TbRepAvgServiceTimeKpiMonthCenLinqDB()

        End Sub 
        ' TB_REP_AVG_SERVICE_TIME_KPI_MONTH
        Const _tableName As String = "TB_REP_AVG_SERVICE_TIME_KPI_MONTH"
        ...
        Public Property SERVICE_NAME_EN() As String
            ...
            End Set
        End Property 
        <Column(Storage:="_SERVICE_NAME_TH", DbType:="VarChar(255)")>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_AVG_SERVICE_TIME_KPI_MONTH table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_AVG_SERVICE_TIME_KPI_MONTH table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_AVG_SERVICE_TIME_KPI_MONTH table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbRepAvgServiceTimeKpiMonthCenLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbRepAvgServiceTimeKpiMonthCenParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified MONTH_NO_SHOP_ID_SHOW_YEAR key is retrieved successfully.
        ...
        '/// Returns an duplicate data record of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified MONTH_NO_SHOP_ID_SHOW_YEAR key is retrieved successfully.
        '/// <param name=cMONTH_NO_SHOP_ID_SHOW_YEAR>The MONTH_NO_SHOP_ID_SHOW_YEAR key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        ...
        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepAvgServiceTimeKpiMonthCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_AVG_SERVICE_TIME_KPI_MONTH by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepAvgServiceTimeKpiMonthCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepAvgServiceTimeKpiMonthCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_REP_AVG_SERVICE_TIME_KPI_MONTH
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SERVICE_ID, SERVICE_NAME_EN, SERVICE_NAME_TH, MONTH_NO, SHOW_MONTH, SHOW_YEAR, REGIS, SERVED, MISSED_CALL, CANCEL, WAIT_WITH_KPI, SERVE_WITH_KPI, NOT_CALL, NOT_CONFIRM, NOT_END, MAX_WT, MAX_HT)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_REP_AVG_SERVICE_TIME_KPI_MONTH
        ...
        'Get Delete Record in table TB_REP_AVG_SERVICE_TIME_KPI_MONTH
        ...
        'Get Select Statement for table TB_REP_AVG_SERVICE_TIME_KPI_MONTH
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SHOP_ID, SHOP_NAME_TH, SHOP_NAME_EN, SERVICE_ID, SERVICE_NAME_EN, SERVICE_NAME_TH, MONTH_NO, SHOW_MONTH, SHOW_YEAR, REGIS, SERVED, MISSED_CALL, CANCEL, WAIT_WITH_KPI, SERVE_WITH_KPI, NOT_CALL, NOT_CONFIRM, NOT_END, MAX_WT, MAX_HT FROM " & tableName
                Return Sql
            End Get
        End Property
