...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_YEAR table CenLinqDB.
    '[Create by  on May, 31 2012]
    Public Class TbRepAvgServiceTimeKpiYearCenLinqDB
        Public sub TbRepAvgServiceTimeKpiYearCenLinqDB()

        End Sub 
        ' TB_REP_AVG_SERVICE_TIME_KPI_YEAR
        Const _tableName As String = "TB_REP_AVG_SERVICE_TIME_KPI_YEAR"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_REP_AVG_SERVICE_TIME_KPI_YEAR table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_REP_AVG_SERVICE_TIME_KPI_YEAR table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_REP_AVG_SERVICE_TIME_KPI_YEAR table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_YEAR by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_REP_AVG_SERVICE_TIME_KPI_YEAR by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As TbRepAvgServiceTimeKpiYearCenLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_REP_AVG_SERVICE_TIME_KPI_YEAR by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As TbRepAvgServiceTimeKpiYearCenParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_REP_AVG_SERVICE_TIME_KPI_YEAR by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbRepAvgServiceTimeKpiYearCenLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_REP_AVG_SERVICE_TIME_KPI_YEAR by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbRepAvgServiceTimeKpiYearCenParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbRepAvgServiceTimeKpiYearCenParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get update statement form table TB_REP_AVG_SERVICE_TIME_KPI_YEAR
        ...
        'Get Delete Record in table TB_REP_AVG_SERVICE_TIME_KPI_YEAR
        ...
        'Get Select Statement for table TB_REP_AVG_SERVICE_TIME_KPI_YEAR
