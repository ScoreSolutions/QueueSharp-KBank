...
Namespace Common.Utilities
    Public Class SqlDB
        ...
        Protected Shared ReadOnly Property ShopMainConnectionString() As String
            Get
                Try
        ...
        Protected Shared ReadOnly Property ShopDisplayConnectionString() As String
            Get
                Try
        ...
        Protected Shared ReadOnly Property HQDrConnectionString() As String
            Get
                Try
                    Return "Data Source=" & HQDRServer() & ";Initial Catalog=" & HQDRDatabase() & ";User ID=" & HQDRUsername() & ";Password=" & HQDRPassword()
                Catch ex As Exception
                    Throw New ApplicationException(ErrorConnectionString, ex)
                End Try
            End Get
