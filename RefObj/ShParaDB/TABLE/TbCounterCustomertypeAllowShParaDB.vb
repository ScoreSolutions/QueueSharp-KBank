...
Namespace TABLE
    'Represents a transaction for TB_COUNTER_CUSTOMERTYPE_ALLOW table Parameter.
    '[Create by  on March, 26 2012]

    <Table(Name:="TB_COUNTER_CUSTOMERTYPE_ALLOW")>  _
    Public Class TbCounterCustomertypeAllowShParaDB
