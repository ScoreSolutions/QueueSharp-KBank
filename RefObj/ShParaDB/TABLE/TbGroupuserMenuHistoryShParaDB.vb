...
Namespace TABLE
    'Represents a transaction for TB_GROUPUSER_MENU_HISTORY table Parameter.
    '[Create by  on March, 26 2012]

    <Table(Name:="TB_GROUPUSER_MENU_HISTORY")>  _
    Public Class TbGroupuserMenuHistoryShParaDB
