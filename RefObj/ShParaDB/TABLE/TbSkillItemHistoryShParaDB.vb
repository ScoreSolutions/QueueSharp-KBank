...
Namespace TABLE
    'Represents a transaction for TB_SKILL_ITEM_HISTORY table Parameter.
    '[Create by  on March, 5 2012]

    <Table(Name:="TB_SKILL_ITEM_HISTORY")>  _
    Public Class TbSkillItemHistoryShParaDB
        ...
        Dim _TB_SKILL_ITEM_ID As Long = 0
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_TB_SKILL_ITEM_ID", DbType:="Int NOT NULL ",CanBeNull:=false)>  _
        Public Property TB_SKILL_ITEM_ID() As Long
            Get
                Return _TB_SKILL_ITEM_ID
            End Get
            Set(ByVal value As Long)
               _TB_SKILL_ITEM_ID = value
            End Set
        End Property 
