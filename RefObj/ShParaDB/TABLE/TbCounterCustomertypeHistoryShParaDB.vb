...
Namespace TABLE
    'Represents a transaction for TB_COUNTER_CUSTOMERTYPE_HISTORY table Parameter.
    '[Create by  on March, 26 2012]

    <Table(Name:="TB_COUNTER_CUSTOMERTYPE_HISTORY")>  _
    Public Class TbCounterCustomertypeHistoryShParaDB
