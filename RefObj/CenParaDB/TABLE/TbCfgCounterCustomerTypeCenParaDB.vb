...
Namespace TABLE
    'Represents a transaction for TB_CFG_COUNTER_CUSTOMER_TYPE table Parameter.
    '[Create by  on July, 16 2013]

    <Table(Name:="TB_CFG_COUNTER_CUSTOMER_TYPE")>  _
    Public Class TbCfgCounterCustomerTypeCenParaDB
