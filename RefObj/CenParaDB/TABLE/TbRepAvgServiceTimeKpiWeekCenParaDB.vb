...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_WEEK table Parameter.
    '[Create by  on March, 9 2013]

    <Table(Name:="TB_REP_AVG_SERVICE_TIME_KPI_WEEK")>  _
    Public Class TbRepAvgServiceTimeKpiWeekCenParaDB
