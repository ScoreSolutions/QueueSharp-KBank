...
Namespace TABLE
    'Represents a transaction for TB_REP_CUST_CATEGORY_WEEK table Parameter.
    '[Create by  on March, 27 2013]

    <Table(Name:="TB_REP_CUST_CATEGORY_WEEK")>  _
    Public Class TbRepCustCategoryWeekCenParaDB
