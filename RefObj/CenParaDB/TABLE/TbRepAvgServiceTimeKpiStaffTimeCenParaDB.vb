...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_STAFF_TIME table Parameter.
    '[Create by  on June, 8 2012]

    <Table(Name:="TB_REP_AVG_SERVICE_TIME_KPI_STAFF_TIME")>  _
    Public Class TbRepAvgServiceTimeKpiStaffTimeCenParaDB
