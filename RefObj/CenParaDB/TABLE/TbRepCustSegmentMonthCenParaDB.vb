...
Namespace TABLE
    'Represents a transaction for TB_REP_CUST_SEGMENT_MONTH table Parameter.
    '[Create by  on March, 6 2013]

    <Table(Name:="TB_REP_CUST_SEGMENT_MONTH")>  _
    Public Class TbRepCustSegmentMonthCenParaDB
