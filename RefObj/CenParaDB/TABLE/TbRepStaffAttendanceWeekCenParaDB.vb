...
Namespace TABLE
    'Represents a transaction for TB_REP_STAFF_ATTENDANCE_WEEK table Parameter.
    '[Create by  on Febuary, 6 2014]

    <Table(Name:="TB_REP_STAFF_ATTENDANCE_WEEK")>  _
    Public Class TbRepStaffAttendanceWeekCenParaDB
