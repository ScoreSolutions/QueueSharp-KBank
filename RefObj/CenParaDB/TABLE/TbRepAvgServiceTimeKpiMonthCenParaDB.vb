...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_MONTH table Parameter.
    '[Create by  on March, 8 2013]

    <Table(Name:="TB_REP_AVG_SERVICE_TIME_KPI_MONTH")>  _
    Public Class TbRepAvgServiceTimeKpiMonthCenParaDB
