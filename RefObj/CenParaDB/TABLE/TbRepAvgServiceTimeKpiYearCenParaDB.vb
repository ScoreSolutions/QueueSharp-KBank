...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_YEAR table Parameter.
    '[Create by  on May, 31 2012]

    <Table(Name:="TB_REP_AVG_SERVICE_TIME_KPI_YEAR")>  _
    Public Class TbRepAvgServiceTimeKpiYearCenParaDB
