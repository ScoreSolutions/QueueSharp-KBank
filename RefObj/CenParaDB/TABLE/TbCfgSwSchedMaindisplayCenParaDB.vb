...
Namespace TABLE
    'Represents a transaction for TB_CFG_SW_SCHED_MAINDISPLAY table Parameter.
    '[Create by  on June, 27 2013]

    <Table(Name:="TB_CFG_SW_SCHED_MAINDISPLAY")>  _
    Public Class TbCfgSwSchedMaindisplayCenParaDB
