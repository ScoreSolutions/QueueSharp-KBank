...
Namespace TABLE
    'Represents a transaction for TB_REP_AVG_SERVICE_TIME_KPI_STAFF_YEAR table Parameter.
    '[Create by  on June, 8 2012]

    <Table(Name:="TB_REP_AVG_SERVICE_TIME_KPI_STAFF_YEAR")>  _
    Public Class TbRepAvgServiceTimeKpiStaffYearCenParaDB
