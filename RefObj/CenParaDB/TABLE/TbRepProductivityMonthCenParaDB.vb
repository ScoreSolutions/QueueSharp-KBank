...
Namespace TABLE
    'Represents a transaction for TB_REP_PRODUCTIVITY_MONTH table Parameter.
    '[Create by  on March, 11 2013]

    <Table(Name:="TB_REP_PRODUCTIVITY_MONTH")>  _
    Public Class TbRepProductivityMonthCenParaDB
