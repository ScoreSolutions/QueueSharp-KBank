...
Namespace TABLE
    'Represents a transaction for TB_REP_CUST_NETWORK_MONTH table Parameter.
    '[Create by  on December, 20 2013]

    <Table(Name:="TB_REP_CUST_NETWORK_MONTH")>  _
    Public Class TbRepCustNetworkMonthCenParaDB
