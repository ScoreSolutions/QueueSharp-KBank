...
Namespace TABLE
    'Represents a transaction for TB_REP_SUMMARY_DAILY_REPORT table Parameter.
    '[Create by  on August, 13 2013]

    <Table(Name:="TB_REP_SUMMARY_DAILY_REPORT")>  _
    Public Class TbRepSummaryDailyReportCenParaDB
