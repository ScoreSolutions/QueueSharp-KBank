...
Namespace TABLE
    'Represents a transaction for TB_REP_APPOINTMENT_SHOP_MONTH table Parameter.
    '[Create by  on March, 23 2013]

    <Table(Name:="TB_REP_APPOINTMENT_SHOP_MONTH")>  _
    Public Class TbRepAppointmentShopMonthCenParaDB
