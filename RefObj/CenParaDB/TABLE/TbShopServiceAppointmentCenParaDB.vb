...
Namespace TABLE
    'Represents a transaction for TB_SHOP_SERVICE_APPOINTMENT table Parameter.
    '[Create by  on September, 17 2013]

    <Table(Name:="TB_SHOP_SERVICE_APPOINTMENT")>  _
    Public Class TbShopServiceAppointmentCenParaDB
