...
Namespace TABLE
    'Represents a transaction for TB_REP_CAPACITY_SHOP_MONTH table Parameter.
    '[Create by  on March, 25 2013]

    <Table(Name:="TB_REP_CAPACITY_SHOP_MONTH")>  _
    Public Class TbRepCapacityShopMonthCenParaDB
