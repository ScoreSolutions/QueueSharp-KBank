...
Namespace TABLE
    'Represents a transaction for TB_MESSAGE table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbMessageShLinqDB
        Public sub TbMessageShLinqDB()

        End Sub 
        ' TB_MESSAGE
        Const _tableName As String = "TB_MESSAGE"
        ...
        Private Sub ClearData()
            ...
            _CUSTOMER_ID = ""
            _MESSAGE = ""
            _MESSAGE_DATE = New DateTime(1,1,1)
            _MESSAGE_STATUS = 0
            _CREATE_BY = 0
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_MESSAGE table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_MESSAGE table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_MESSAGE table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_MESSAGE by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_MESSAGE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbMessageShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_MESSAGE by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbMessageShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_MESSAGE by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("message_date")) = False Then _message_date = Convert.ToDateTime(Rdr("message_date"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbMessageShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_MESSAGE by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbMessageShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbMessageShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("message_date")) = False Then ret.message_date = Convert.ToDateTime(Rdr("message_date"))
        ...
        'Get Insert Statement for table TB_MESSAGE
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, QUEUE_NO, CUSTOMER_ID, MESSAGE, MESSAGE_DATE, MESSAGE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetString(_QUEUE_NO) & ", "
                sql += DB.SetString(_CUSTOMER_ID) & ", "
                sql += DB.SetString(_MESSAGE) & ", "
                sql += DB.SetDateTime(_MESSAGE_DATE) & ", "
        ...
        'Get update statement form table TB_MESSAGE
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "MESSAGE_DATE = " & DB.SetDateTime(_MESSAGE_DATE) & ", "
        ...
        'Get Delete Record in table TB_MESSAGE
        ...
        'Get Select Statement for table TB_MESSAGE
