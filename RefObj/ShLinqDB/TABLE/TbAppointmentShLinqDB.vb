...
Namespace TABLE
    'Represents a transaction for TB_APPOINTMENT table ShLinqDB.
    '[Create by  on January, 22 2012]
    Public Class TbAppointmentShLinqDB
        Public sub TbAppointmentShLinqDB()

        End Sub 
        ' TB_APPOINTMENT
        Const _tableName As String = "TB_APPOINTMENT"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_APPOINTMENT table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_APPOINTMENT table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_APPOINTMENT table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_APPOINTMENT by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_APPOINTMENT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbAppointmentShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_APPOINTMENT by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbAppointmentShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_APPOINTMENT by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("before_time")) = False Then _before_time = Convert.ToInt16(Rdr("before_time"))
                        If Convert.IsDBNull(Rdr("late_time")) = False Then _late_time = Convert.ToInt16(Rdr("late_time"))
                        If Convert.IsDBNull(Rdr("before_app_time")) = False Then _before_app_time = Convert.ToInt16(Rdr("before_app_time"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbAppointmentShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_APPOINTMENT by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbAppointmentShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbAppointmentShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("before_time")) = False Then ret.before_time = Convert.ToInt16(Rdr("before_time"))
                        If Convert.IsDBNull(Rdr("late_time")) = False Then ret.late_time = Convert.ToInt16(Rdr("late_time"))
                        If Convert.IsDBNull(Rdr("before_app_time")) = False Then ret.before_app_time = Convert.ToInt16(Rdr("before_app_time"))
        ...
        'Get Insert Statement for table TB_APPOINTMENT
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, BEFORE_TIME, LATE_TIME, BEFORE_APP_TIME, START_TIME_H, START_TIME_M, END_TIME_H, END_TIME_M, SLOT)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_BEFORE_TIME) & ", "
                sql += DB.SetDouble(_LATE_TIME) & ", "
                sql += DB.SetDouble(_BEFORE_APP_TIME) & ", "
        ...
        'Get update statement form table TB_APPOINTMENT
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "BEFORE_TIME = " & DB.SetDouble(_BEFORE_TIME) & ", "
                Sql += "LATE_TIME = " & DB.SetDouble(_LATE_TIME) & ", "
                Sql += "BEFORE_APP_TIME = " & DB.SetDouble(_BEFORE_APP_TIME) & ", "
        ...
        'Get Delete Record in table TB_APPOINTMENT
        ...
        'Get Select Statement for table TB_APPOINTMENT
