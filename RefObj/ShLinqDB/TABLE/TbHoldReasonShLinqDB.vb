...
Namespace TABLE
    'Represents a transaction for TB_HOLD_REASON table ShLinqDB.
    '[Create by  on July, 2 2013]
    Public Class TbHoldReasonShLinqDB
        Public sub TbHoldReasonShLinqDB()
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Integer, trans As SQLTransaction) As TbHoldReasonShLinqDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Integer, trans As SQLTransaction) As TbHoldReasonShParaDB
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("master_holdreasonid")) = False Then _master_holdreasonid = Convert.ToInt32(Rdr("master_holdreasonid"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbHoldReasonShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbHoldReasonShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbHoldReasonShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("master_holdreasonid")) = False Then ret.master_holdreasonid = Convert.ToInt32(Rdr("master_holdreasonid"))
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, NAME, PRODUCTIVE, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MASTER_HOLDREASONID)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_MASTER_HOLDREASONID)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "MASTER_HOLDREASONID = " & DB.SetDouble(_MASTER_HOLDREASONID) + ""
                Return Sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, NAME, PRODUCTIVE, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MASTER_HOLDREASONID FROM " & tableName
                Return Sql
            End Get
        End Property
