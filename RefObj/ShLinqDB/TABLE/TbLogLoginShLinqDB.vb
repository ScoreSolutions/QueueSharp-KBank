...
Namespace TABLE
    'Represents a transaction for TB_LOG_LOGIN table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbLogLoginShLinqDB
        Public sub TbLogLoginShLinqDB()

        End Sub 
        ' TB_LOG_LOGIN
        Const _tableName As String = "TB_LOG_LOGIN"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_LOG_LOGIN table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_LOG_LOGIN table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_LOG_LOGIN table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_LOG_LOGIN by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_LOG_LOGIN by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbLogLoginShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_LOG_LOGIN by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbLogLoginShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_LOG_LOGIN by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("reason_id")) = False Then _reason_id = Convert.ToInt32(Rdr("reason_id"))
                        If Convert.IsDBNull(Rdr("productive")) = False Then _productive = Convert.ToInt16(Rdr("productive"))
                        If Convert.IsDBNull(Rdr("action")) = False Then _action = Convert.ToInt16(Rdr("action"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbLogLoginShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_LOG_LOGIN by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbLogLoginShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbLogLoginShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("reason_id")) = False Then ret.reason_id = Convert.ToInt32(Rdr("reason_id"))
                        If Convert.IsDBNull(Rdr("productive")) = False Then ret.productive = Convert.ToInt16(Rdr("productive"))
                        If Convert.IsDBNull(Rdr("action")) = False Then ret.action = Convert.ToInt16(Rdr("action"))
        ...
        'Get Insert Statement for table TB_LOG_LOGIN
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SERVICE_DATE, USER_ID, COUNTER_ID, REASON_ID, PRODUCTIVE, ACTION)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_LOG_LOGIN
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "REASON_ID = " & DB.SetDouble(_REASON_ID) & ", "
        ...
        'Get Delete Record in table TB_LOG_LOGIN
        ...
        'Get Select Statement for table TB_LOG_LOGIN
