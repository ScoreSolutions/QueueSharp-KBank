...
Namespace TABLE
    'Represents a transaction for TB_USER_SERVICE_LOG table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbUserServiceLogShLinqDB
        Public sub TbUserServiceLogShLinqDB()

        End Sub 
        ' TB_USER_SERVICE_LOG
        Const _tableName As String = "TB_USER_SERVICE_LOG"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_USER_SERVICE_LOG table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_USER_SERVICE_LOG table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_USER_SERVICE_LOG table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_USER_SERVICE_LOG by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_USER_SERVICE_LOG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbUserServiceLogShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_USER_SERVICE_LOG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbUserServiceLogShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_USER_SERVICE_LOG by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbUserServiceLogShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_USER_SERVICE_LOG by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbUserServiceLogShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbUserServiceLogShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Insert Statement for table TB_USER_SERVICE_LOG
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, SERVICE_DATE, USER_ID, ITEM_ID, ACTIVE_STATUS)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_USER_SERVICE_LOG
        ...
        'Get Delete Record in table TB_USER_SERVICE_LOG
        ...
        'Get Select Statement for table TB_USER_SERVICE_LOG
