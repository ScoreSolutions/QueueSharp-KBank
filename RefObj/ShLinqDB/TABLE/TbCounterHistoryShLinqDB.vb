...
Namespace TABLE
    'Represents a transaction for TB_COUNTER_HISTORY table ShLinqDB.
    '[Create by  on March, 5 2012]
    Public Class TbCounterHistoryShLinqDB
        Public sub TbCounterHistoryShLinqDB()

        End Sub 
        ' TB_COUNTER_HISTORY
        Const _tableName As String = "TB_COUNTER_HISTORY"
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_TB_COUNTER_ID", DbType:="Int NOT NULL ",CanBeNull:=false)>  _
        Public Property TB_COUNTER_ID() As Long
            Get
                Return _TB_COUNTER_ID
            End Get
            Set(ByVal value As Long)
               _TB_COUNTER_ID = value
            End Set
        End Property 
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_COUNTER_HISTORY table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_COUNTER_HISTORY table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_COUNTER_HISTORY table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_COUNTER_HISTORY by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_COUNTER_HISTORY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As TbCounterHistoryShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_COUNTER_HISTORY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As TbCounterHistoryShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_COUNTER_HISTORY by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("tb_counter_id")) = False Then _tb_counter_id = Convert.ToInt32(Rdr("tb_counter_id"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbCounterHistoryShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_COUNTER_HISTORY by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbCounterHistoryShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbCounterHistoryShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("tb_counter_id")) = False Then ret.tb_counter_id = Convert.ToInt32(Rdr("tb_counter_id"))
        ...
        'Get Insert Statement for table TB_COUNTER_HISTORY
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, COUNTER_CODE, COUNTER_NAME, COUNTER_STATUS, QUICKSERVICE, BEEP, RETURN_CASE, AUTO_SWAP, SPEED_LANE, UNITDISPLAY, AVAILABLE, BACK_OFFICE, COUNTER_MANAGER, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TB_COUNTER_ID)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_TB_COUNTER_ID)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table TB_COUNTER_HISTORY
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "TB_COUNTER_ID = " & DB.SetDouble(_TB_COUNTER_ID) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_COUNTER_HISTORY
        ...
        'Get Select Statement for table TB_COUNTER_HISTORY
