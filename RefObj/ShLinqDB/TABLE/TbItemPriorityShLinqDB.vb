...
Namespace TABLE
    'Represents a transaction for TB_ITEM_PRIORITY table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbItemPriorityShLinqDB
        Public sub TbItemPriorityShLinqDB()

        End Sub 
        ' TB_ITEM_PRIORITY
        Const _tableName As String = "TB_ITEM_PRIORITY"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_ITEM_PRIORITY table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_ITEM_PRIORITY table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_ITEM_PRIORITY table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_ITEM_PRIORITY by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_ITEM_PRIORITY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbItemPriorityShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_ITEM_PRIORITY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbItemPriorityShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_ITEM_PRIORITY by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("item_before")) = False Then _item_before = Convert.ToInt32(Rdr("item_before"))
                        If Convert.IsDBNull(Rdr("item_after")) = False Then _item_after = Convert.ToInt32(Rdr("item_after"))
                        If Convert.IsDBNull(Rdr("imm")) = False Then _imm = Convert.ToInt16(Rdr("imm"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbItemPriorityShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_ITEM_PRIORITY by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbItemPriorityShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbItemPriorityShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("item_before")) = False Then ret.item_before = Convert.ToInt32(Rdr("item_before"))
                        If Convert.IsDBNull(Rdr("item_after")) = False Then ret.item_after = Convert.ToInt32(Rdr("item_after"))
                        If Convert.IsDBNull(Rdr("imm")) = False Then ret.imm = Convert.ToInt16(Rdr("imm"))
        ...
        'Get Insert Statement for table TB_ITEM_PRIORITY
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, ITEM_BEFORE, ITEM_AFTER, IMM, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE)"
                Sql += " VALUES("
                sql += DB.SetDouble(_ID) & ", "
                sql += DB.SetDouble(_ITEM_BEFORE) & ", "
                sql += DB.SetDouble(_ITEM_AFTER) & ", "
                sql += DB.SetDouble(_IMM) & ", "
        ...
        'Get update statement form table TB_ITEM_PRIORITY
        Private ReadOnly Property SqlUpdate() As String
            Get
                Dim Sql As String = ""
                Sql += "UPDATE " & tableName & " SET "
                Sql += "ID = " & DB.SetDouble(_ID) & ", "
                Sql += "ITEM_BEFORE = " & DB.SetDouble(_ITEM_BEFORE) & ", "
                Sql += "ITEM_AFTER = " & DB.SetDouble(_ITEM_AFTER) & ", "
                Sql += "IMM = " & DB.SetDouble(_IMM) & ", "
        ...
        'Get Delete Record in table TB_ITEM_PRIORITY
        ...
        'Get Select Statement for table TB_ITEM_PRIORITY
