...
Namespace TABLE
    'Represents a transaction for TB_USER_ACTION table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbUserActionShLinqDB
        Public sub TbUserActionShLinqDB()

        End Sub 
        ' TB_USER_ACTION
        Const _tableName As String = "TB_USER_ACTION"
        ...
        Dim _ACTION_DATE As  System.Nullable(Of DateTime)  = New DateTime(1,1,1)
        ...
        Public Property USER_ID() As  System.Nullable(Of Long) 
            ...
            End Set
        End Property 
        <Column(Storage:="_ACTION_DATE", DbType:="DateTime")>  _
        Public Property ACTION_DATE() As  System.Nullable(Of DateTime) 
            Get
                Return _ACTION_DATE
            End Get
            Set(ByVal value As  System.Nullable(Of DateTime) )
        ...
        Private Sub ClearData()
            ...
            _USER_ID = 0
            _ACTION_DATE = New DateTime(1,1,1)
            _COUNTER_ID = 0
            _ACTION = 0
        End Sub
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_USER_ACTION table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_USER_ACTION table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_USER_ACTION table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_USER_ACTION by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_USER_ACTION by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbUserActionShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_USER_ACTION by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbUserActionShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_USER_ACTION by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("action_date")) = False Then _action_date = Convert.ToDateTime(Rdr("action_date"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbUserActionShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_USER_ACTION by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbUserActionShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbUserActionShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("action_date")) = False Then ret.action_date = Convert.ToDateTime(Rdr("action_date"))
        ...
        'Get Insert Statement for table TB_USER_ACTION
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, USER_ID, ACTION_DATE, COUNTER_ID, ACTION)"
                Sql += " VALUES("
                ...
                sql += DB.SetDateTime(_ACTION_DATE) & ", "
        ...
        'Get update statement form table TB_USER_ACTION
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "ACTION_DATE = " & DB.SetDateTime(_ACTION_DATE) & ", "
        ...
        'Get Delete Record in table TB_USER_ACTION
        ...
        'Get Select Statement for table TB_USER_ACTION
