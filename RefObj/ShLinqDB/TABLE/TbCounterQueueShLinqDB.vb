    ...
    Public Class TbCounterQueueShLinqDB
       ...
       'Define Public Method 
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, QUEUE_NO, CUSTOMER_ID, CUSTOMER_NAME, SEGMENT, CUSTOMERTYPE_ID, ITEM_ID, COUNTER_ID, USER_ID, SERVICE_DATE, ASSIGN_TIME, CALL_TIME, START_TIME, END_TIME, STATUS, HOLD, COMBO_ITEM_ALL, COMBO_ITEM_END, FLAG, NETWORK_TYPE, ADD_SERVICE, CALL_AUTO_FORCE)"
                Sql += " VALUES("
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, QUEUE_NO, CUSTOMER_ID, CUSTOMER_NAME, SEGMENT, CUSTOMERTYPE_ID, ITEM_ID, COUNTER_ID, USER_ID, SERVICE_DATE, ASSIGN_TIME, CALL_TIME, START_TIME, END_TIME, STATUS, HOLD, COMBO_ITEM_ALL, COMBO_ITEM_END, FLAG, NETWORK_TYPE, ADD_SERVICE, CALL_AUTO_FORCE FROM " & tableName
                Return Sql
            End Get
        End Property
