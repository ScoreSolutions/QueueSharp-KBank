...
Namespace TABLE
    'Represents a transaction for TB_LOGOUT_REASON table ShLinqDB.
    '[Create by  on July, 2 2013]
    Public Class TbLogoutReasonShLinqDB
        Public sub TbLogoutReasonShLinqDB()

        End Sub 
        ' TB_LOGOUT_REASON
        Const _tableName As String = "TB_LOGOUT_REASON"
        ...
        Dim _MASTER_LOGOUTREASONID As  System.Nullable(Of Long)  = 0
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_MASTER_LOGOUTREASONID", DbType:="Int")>  _
        Public Property MASTER_LOGOUTREASONID() As  System.Nullable(Of Long) 
            Get
                Return _MASTER_LOGOUTREASONID
            End Get
            Set(ByVal value As  System.Nullable(Of Long) )
               _MASTER_LOGOUTREASONID = value
            End Set
        End Property 
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_LOGOUT_REASON table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_LOGOUT_REASON table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_LOGOUT_REASON table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_LOGOUT_REASON by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_LOGOUT_REASON by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Integer, trans As SQLTransaction) As TbLogoutReasonShLinqDB
            Return doGetData("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_LOGOUT_REASON by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Integer, trans As SQLTransaction) As TbLogoutReasonShParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function


        '/// Returns an indication whether the record of TB_LOGOUT_REASON by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("master_logoutreasonid")) = False Then _master_logoutreasonid = Convert.ToInt32(Rdr("master_logoutreasonid"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbLogoutReasonShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_LOGOUT_REASON by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbLogoutReasonShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbLogoutReasonShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("master_logoutreasonid")) = False Then ret.master_logoutreasonid = Convert.ToInt32(Rdr("master_logoutreasonid"))
        ...
        'Get Insert Statement for table TB_LOGOUT_REASON
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, NAME, PRODUCTIVE, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MASTER_LOGOUTREASONID)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_MASTER_LOGOUTREASONID)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table TB_LOGOUT_REASON
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "MASTER_LOGOUTREASONID = " & DB.SetDouble(_MASTER_LOGOUTREASONID) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_LOGOUT_REASON
        ...
        'Get Select Statement for table TB_LOGOUT_REASON
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, NAME, PRODUCTIVE, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MASTER_LOGOUTREASONID FROM " & tableName
                Return Sql
            End Get
        End Property
