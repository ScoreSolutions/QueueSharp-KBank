...
Namespace TABLE
    'Represents a transaction for TB_MAPING_CUSTOMER table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbMapingCustomerShLinqDB
        Public sub TbMapingCustomerShLinqDB()

        End Sub 
        ' TB_MAPING_CUSTOMER
        Const _tableName As String = "TB_MAPING_CUSTOMER"
        ...
        Public Property CUSTOMERTYPE_ID() As  System.Nullable(Of Long) 
            ...
            End Set
        End Property 
        <Column(Storage:="_SERMENT", DbType:="VarChar(100)")>  _
        Public Property SERMENT() As  String 
            Get
                Return _SERMENT
            End Get
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_MAPING_CUSTOMER table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_MAPING_CUSTOMER table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_MAPING_CUSTOMER table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_MAPING_CUSTOMER by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_MAPING_CUSTOMER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbMapingCustomerShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_MAPING_CUSTOMER by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbMapingCustomerShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_MAPING_CUSTOMER by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("serment")) = False Then _serment = Rdr("serment").ToString()
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbMapingCustomerShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_MAPING_CUSTOMER by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbMapingCustomerShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbMapingCustomerShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("serment")) = False Then ret.serment = Rdr("serment").ToString()
        ...
        'Get Insert Statement for table TB_MAPING_CUSTOMER
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, CUSTOMERTYPE_ID, SERMENT)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_MAPING_CUSTOMER
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "SERMENT = " & DB.SetString(_SERMENT) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_MAPING_CUSTOMER
        ...
        'Get Select Statement for table TB_MAPING_CUSTOMER
