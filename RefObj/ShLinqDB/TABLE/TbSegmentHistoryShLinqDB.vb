...
Namespace TABLE
    'Represents a transaction for TB_SEGMENT_HISTORY table ShLinqDB.
    '[Create by  on March, 5 2012]
    Public Class TbSegmentHistoryShLinqDB
        Public sub TbSegmentHistoryShLinqDB()

        End Sub 
        ' TB_SEGMENT_HISTORY
        Const _tableName As String = "TB_SEGMENT_HISTORY"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_SEGMENT_HISTORY table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_SEGMENT_HISTORY table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_SEGMENT_HISTORY table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_SEGMENT_HISTORY by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_SEGMENT_HISTORY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Long, trans As SQLTransaction) As TbSegmentHistoryShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_SEGMENT_HISTORY by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Long, trans As SQLTransaction) As TbSegmentHistoryShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_SEGMENT_HISTORY by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("tb_segment_id")) = False Then _tb_segment_id = Convert.ToInt32(Rdr("tb_segment_id"))
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbSegmentHistoryShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_SEGMENT_HISTORY by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbSegmentHistoryShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbSegmentHistoryShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("tb_segment_id")) = False Then ret.tb_segment_id = Convert.ToInt32(Rdr("tb_segment_id"))
        ...
        'Get Insert Statement for table TB_SEGMENT_HISTORY
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, SEGMENT, ACTIVE_STATUS, CUSTOMERTYPE_ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, TB_SEGMENT_ID)"
                Sql += " VALUES("
                ...
                sql += DB.SetDouble(_TB_SEGMENT_ID)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        'Get update statement form table TB_SEGMENT_HISTORY
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "TB_SEGMENT_ID = " & DB.SetDouble(_TB_SEGMENT_ID) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_SEGMENT_HISTORY
        ...
        'Get Select Statement for table TB_SEGMENT_HISTORY
