...
Namespace TABLE
    'Represents a transaction for TB_AVG_USER_SERVICETIME table ShLinqDB.
    '[Create by  on January, 27 2012]
    Public Class TbAvgUserServicetimeShLinqDB
        Public sub TbAvgUserServicetimeShLinqDB()

        End Sub 
        ' TB_AVG_USER_SERVICETIME
        Const _tableName As String = "TB_AVG_USER_SERVICETIME"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_AVG_USER_SERVICETIME table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_AVG_USER_SERVICETIME table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_AVG_USER_SERVICETIME table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_AVG_USER_SERVICETIME by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_AVG_USER_SERVICETIME by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbAvgUserServicetimeShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_AVG_USER_SERVICETIME by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbAvgUserServicetimeShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_AVG_USER_SERVICETIME by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("avg_time")) = False Then _avg_time = Convert.ToInt32(Rdr("avg_time"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbAvgUserServicetimeShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_AVG_USER_SERVICETIME by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbAvgUserServicetimeShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbAvgUserServicetimeShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("avg_time")) = False Then ret.avg_time = Convert.ToInt32(Rdr("avg_time"))
        ...
        'Get Insert Statement for table TB_AVG_USER_SERVICETIME
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, USER_ID, ITEM_ID, AVG_TIME)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_AVG_USER_SERVICETIME
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "AVG_TIME = " & DB.SetDouble(_AVG_TIME) + ""
                Return Sql
            End Get
        End Property


        'Get Delete Record in table TB_AVG_USER_SERVICETIME
        ...
        'Get Select Statement for table TB_AVG_USER_SERVICETIME
