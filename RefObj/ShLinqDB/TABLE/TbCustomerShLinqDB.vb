...
Namespace TABLE
    'Represents a transaction for TB_CUSTOMER table ShLinqDB.
    '[Create by  on Febuary, 27 2014]
    Public Class TbCustomerShLinqDB
        Public sub TbCustomerShLinqDB()
        ...
        Dim _PA_GROUP As  String  = ""
        Dim _URL_CAPTURE As  String  = ""
        Dim _URL_CAPTURE_DATE As  String  = ""
        Dim _CONTACT_ID As  String  = ""
        Dim _ACCOUNT_NO As  String  = ""
        Dim _BILLING_SYSTEM As  String  = ""
        ...
        Public Property CORPORATE_TYPE() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_PA_GROUP", DbType:="VarChar(255)")>  _
        Public Property PA_GROUP() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_URL_CAPTURE", DbType:="VarChar(2000)")>  _
        Public Property URL_CAPTURE() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_URL_CAPTURE_DATE", DbType:="VarChar(50)")>  _
        Public Property URL_CAPTURE_DATE() As  String 
            Get
                Return _URL_CAPTURE_DATE
            End Get
            Set(ByVal value As  String )
               _URL_CAPTURE_DATE = value
            End Set
        End Property 
        <Column(Storage:="_CONTACT_ID", DbType:="VarChar(100)")>  _
        ...
        Public Property ACCOUNT_NO() As  String 
            ...
            End Set
        End Property 
        <Column(Storage:="_BILLING_SYSTEM", DbType:="VarChar(100)")>  _
        Public Property BILLING_SYSTEM() As  String 
            Get
                Return _BILLING_SYSTEM
            End Get
            Set(ByVal value As  String )
               _BILLING_SYSTEM = value
            End Set
        End Property 
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Long, trans As SQLTransaction) As TbCustomerShLinqDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Long, trans As SQLTransaction) As TbCustomerShParaDB
            Return doMappingParameter("ID = " & DB.SetDouble(cID), trans)
        End Function

        Public Function GetParameterByMobileNo(ByVal cMobileNo As String, ByVal trans As SqlTransaction) As TbCustomerShParaDB
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("pa_group")) = False Then _pa_group = Rdr("pa_group").ToString()
                        If Convert.IsDBNull(Rdr("url_capture")) = False Then _url_capture = Rdr("url_capture").ToString()
                        If Convert.IsDBNull(Rdr("url_capture_date")) = False Then _url_capture_date = Rdr("url_capture_date").ToString()
                        If Convert.IsDBNull(Rdr("contact_id")) = False Then _contact_id = Rdr("contact_id").ToString()
                        If Convert.IsDBNull(Rdr("account_no")) = False Then _account_no = Rdr("account_no").ToString()
                        If Convert.IsDBNull(Rdr("billing_system")) = False Then _billing_system = Rdr("billing_system").ToString()
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbCustomerShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbCustomerShParaDB
            ClearData()
            _haveData  = False
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, TITLE_NAME, F_NAME, L_NAME, MOBILE_NO, MOBILE_STATUS, EMAIL, SEGMENT_LEVEL, BIRTH_DATE, CATEGORY, ACCOUNT_BALANCE, CONTACT_CLASS, SERVICE_YEAR, CHUM_SCORE, PREFER_LANG, CAMPAIGN_CODE, CAMPAIGN_NAME, NETWORK_TYPE, CREATE_DATE, CREATE_BY, UPDATE_DATE, UPDATE_BY, CAMPAIGN_NAME_EN, CAMPAIGN_DESC, CAMPAIGN_DESC_TH2, CAMPAIGN_DESC_EN2, CORPORATE_TYPE, PA_GROUP, URL_CAPTURE, URL_CAPTURE_DATE, CONTACT_ID, ACCOUNT_NO, BILLING_SYSTEM)"
                Sql += " VALUES("
                ...
                sql += DB.SetString(_PA_GROUP) & ", "
                sql += DB.SetString(_URL_CAPTURE) & ", "
                sql += DB.SetString(_URL_CAPTURE_DATE) & ", "
                sql += DB.SetString(_CONTACT_ID) & ", "
                sql += DB.SetString(_ACCOUNT_NO) & ", "
                sql += DB.SetString(_BILLING_SYSTEM)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "PA_GROUP = " & DB.SetString(_PA_GROUP) & ", "
                Sql += "URL_CAPTURE = " & DB.SetString(_URL_CAPTURE) & ", "
                Sql += "URL_CAPTURE_DATE = " & DB.SetString(_URL_CAPTURE_DATE) & ", "
                Sql += "CONTACT_ID = " & DB.SetString(_CONTACT_ID) & ", "
                Sql += "ACCOUNT_NO = " & DB.SetString(_ACCOUNT_NO) & ", "
                Sql += "BILLING_SYSTEM = " & DB.SetString(_BILLING_SYSTEM) + ""
                Return Sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, TITLE_NAME, F_NAME, L_NAME, MOBILE_NO, MOBILE_STATUS, EMAIL, SEGMENT_LEVEL, BIRTH_DATE, CATEGORY, ACCOUNT_BALANCE, CONTACT_CLASS, SERVICE_YEAR, CHUM_SCORE, PREFER_LANG, CAMPAIGN_CODE, CAMPAIGN_NAME, NETWORK_TYPE, CREATE_DATE, CREATE_BY, UPDATE_DATE, UPDATE_BY, CAMPAIGN_NAME_EN, CAMPAIGN_DESC, CAMPAIGN_DESC_TH2, CAMPAIGN_DESC_EN2, CORPORATE_TYPE, PA_GROUP, URL_CAPTURE, URL_CAPTURE_DATE, CONTACT_ID, ACCOUNT_NO, BILLING_SYSTEM FROM " & tableName
                Return Sql
            End Get
        End Property
