...
Namespace TABLE
    'Represents a transaction for TB_STAFF_SMS_CONFIG table ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class TbStaffSmsConfigShLinqDB
        Public sub TbStaffSmsConfigShLinqDB()

        End Sub 
        ' TB_STAFF_SMS_CONFIG
        Const _tableName As String = "TB_STAFF_SMS_CONFIG"
        ...
        Dim _MULTIPLY As  System.Nullable(Of Long)  = 0
        ...
        Public Property COUNTER_ID() As  System.Nullable(Of Long) 
            ...
            End Set
        End Property 
        <Column(Storage:="_MULTIPLY", DbType:="Int")>  _
        Public Property MULTIPLY() As  System.Nullable(Of Long) 
            Get
                Return _MULTIPLY
            End Get
            Set(ByVal value As  System.Nullable(Of Long) )
            ...
            End Set
        End Property 
        <Column(Storage:="_MOBILE_NO", DbType:="VarChar(10)")>  _
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the current data is inserted into TB_STAFF_SMS_CONFIG table successfully.
        ...
        '/// Returns an indication whether the current data is updated to TB_STAFF_SMS_CONFIG table successfully.
        '/// <param name=userID>The current user.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the current data is deleted from TB_STAFF_SMS_CONFIG table successfully.
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        ...
        '/// Returns an indication whether the record of TB_STAFF_SMS_CONFIG by specified id key is retrieved successfully.
        ...
        '/// Returns an indication whether the record and Mapping field to Data Class of TB_STAFF_SMS_CONFIG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cid As Integer, trans As SQLTransaction) As TbStaffSmsConfigShLinqDB
            Return doGetData("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record and Mapping field to Para Class of TB_STAFF_SMS_CONFIG by specified id key is retrieved successfully.
        '/// <param name=cid>The id key.</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cid As Integer, trans As SQLTransaction) As TbStaffSmsConfigShParaDB
            Return doMappingParameter("id = " & DB.SetDouble(cid) & " ", trans)
        End Function


        '/// Returns an indication whether the record of TB_STAFF_SMS_CONFIG by specified condition is retrieved successfully.
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("multiply")) = False Then _multiply = Convert.ToInt32(Rdr("multiply"))
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbStaffSmsConfigShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of TB_STAFF_SMS_CONFIG by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbStaffSmsConfigShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbStaffSmsConfigShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("multiply")) = False Then ret.multiply = Convert.ToInt32(Rdr("multiply"))
        ...
        'Get Insert Statement for table TB_STAFF_SMS_CONFIG
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, COUNTER_ID, MULTIPLY, MOBILE_NO)"
                Sql += " VALUES("
        ...
        'Get update statement form table TB_STAFF_SMS_CONFIG
        ...
        'Get Delete Record in table TB_STAFF_SMS_CONFIG
        ...
        'Get Select Statement for table TB_STAFF_SMS_CONFIG
