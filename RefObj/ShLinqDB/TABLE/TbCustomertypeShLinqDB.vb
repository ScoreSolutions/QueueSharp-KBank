...
Namespace TABLE
    'Represents a transaction for TB_CUSTOMERTYPE table ShLinqDB.
    '[Create by  on December, 20 2013]
    Public Class TbCustomertypeShLinqDB
        Public sub TbCustomertypeShLinqDB()
        ...
        Dim _MASTER_CUSTOMERTYPEID As  String  = ""
        ...
        Public Property UPDATE_DATE() As  System.Nullable(Of DateTime) 
            ...
            End Set
        End Property 
        <Column(Storage:="_MASTER_CUSTOMERTYPEID", DbType:="VarChar(50)")>  _
        Public Property MASTER_CUSTOMERTYPEID() As  String 
            Get
                Return _MASTER_CUSTOMERTYPEID
            End Get
            Set(ByVal value As  String )
               _MASTER_CUSTOMERTYPEID = value
            End Set
        End Property 
       ...
       'Define Public Method 
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetDataByPK(cID As Integer, trans As SQLTransaction) As TbCustomertypeShLinqDB
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Public Function GetParameter(cID As Integer, trans As SQLTransaction) As TbCustomertypeShParaDB
            ...
            If whText.Trim() <> "" Then
                ...
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("master_customertypeid")) = False Then _master_customertypeid = Rdr("master_customertypeid").ToString()
                    Else
                        ret = False
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As TbCustomertypeShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As TbCustomertypeShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New TbCustomertypeShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
                    ...
                    If Rdr.Read() Then
                        ...
                        If Convert.IsDBNull(Rdr("master_customertypeid")) = False Then ret.master_customertypeid = Rdr("master_customertypeid").ToString()
        ...
        Private ReadOnly Property SqlInsert() As String 
            Get
                Dim Sql As String=""
                Sql += "INSERT INTO " & tableName  & " (ID, CUSTOMERTYPE_CODE, CUSTOMERTYPE_NAME, TXT_QUEUE, MIN_QUEUE, MAX_QUEUE, PRIORITY_VALUE, COLOR, APP, DEF, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MASTER_CUSTOMERTYPEID)"
                Sql += " VALUES("
                ...
                sql += DB.SetString(_MASTER_CUSTOMERTYPEID)
                sql += ")"
                Return sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlUpdate() As String
            Get
                ...
                Sql += "MASTER_CUSTOMERTYPEID = " & DB.SetString(_MASTER_CUSTOMERTYPEID) + ""
                Return Sql
            End Get
        End Property
        ...
        Private ReadOnly Property SqlSelect() As String
            Get
                Dim Sql As String = "SELECT ID, CUSTOMERTYPE_CODE, CUSTOMERTYPE_NAME, TXT_QUEUE, MIN_QUEUE, MAX_QUEUE, PRIORITY_VALUE, COLOR, APP, DEF, ACTIVE_STATUS, CREATE_BY, CREATE_DATE, UPDATE_BY, UPDATE_DATE, MASTER_CUSTOMERTYPEID FROM " & tableName
                Return Sql
            End Get
        End Property
