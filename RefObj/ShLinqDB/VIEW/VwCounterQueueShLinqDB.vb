...
Namespace VIEW
    'Represents a transaction for VW_Counter_Queue view ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class VwCounterQueueShLinqDB
        Public sub VwCounterQueueShLinqDB()

        End Sub 
        ' VW_Counter_Queue
        Const _viewName As String = "VW_Counter_Queue"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of VW_Counter_Queue by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As VwCounterQueueShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of VW_Counter_Queue by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As VwCounterQueueShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New VwCounterQueueShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Select Statement for table VW_Counter_Queue
