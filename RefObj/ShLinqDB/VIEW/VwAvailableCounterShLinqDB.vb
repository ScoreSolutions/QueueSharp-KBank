...
Namespace VIEW
    'Represents a transaction for VW_Available_Counter view ShLinqDB.
    '[Create by  on Febuary, 27 2012]
    Public Class VwAvailableCounterShLinqDB
        Public sub VwAvailableCounterShLinqDB()

        End Sub 
        ' VW_Available_Counter
        Const _viewName As String = "VW_Available_Counter"
       ...
       'Define Public Method 
        ...
        '/// Returns an indication whether the record of VW_Available_Counter by specified condition is retrieved successfully.
        ...
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doGetData(whText As String, trans As SQLTransaction) As VwAvailableCounterShLinqDB
            ClearData()
            _haveData  = False
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
        ...
        '/// Returns an indication whether the Class Data of VW_Available_Counter by specified condition is retrieved successfully.
        '/// <param name=whText>The condition specify the deleting record(s).</param>
        '/// <param name=trans>The System.Data.SQLClient.SQLTransaction used by this System.Data.SQLClient.SQLCommand.</param>
        '/// <returns>true if data is retrieved successfully; otherwise, false.</returns>
        Private Function doMappingParameter(whText As String, trans As SQLTransaction) As VwAvailableCounterShParaDB
            ClearData()
            _haveData  = False
            Dim ret As New VwAvailableCounterShParaDB
            If whText.Trim() <> "" Then
                Dim tmpWhere As String = " WHERE " & whText
                Dim Rdr As SQLDataReader
                Try
        ...
        'Get Select Statement for table VW_Available_Counter
