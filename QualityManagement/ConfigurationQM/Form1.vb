...
Public Class Form1
    ...
    Private Sub SaveToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveToolStripMenuItem.Click
        Try
            ...
            ConfigQM.SetValue("Customer", "CustomerMICInput", cboMICCustomer.SelectedItem.ToString)

        Catch ex As Exception
            MessageBox.Show(ex.Message & vbCrLf & ConfigQM.Name, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End Try
