...
#End Region
    ...
    Public Function InitializeHostWebcam(ByVal InputDeviceIndex As Integer, ByVal QNo As String) As Boolean
        ...
        Catch ex As Exception
            QM.Errorlog("HostWebcam.InitializeHostWebcam : Exception : " & ex.Message & "HostCapture Stopped :" & HostCapture.Stopped)
            CheckHost = False
            Return False
        End Try
    End Function
    ...
    Private Function CheckVideoCompressors(ByVal InputDeviceIndex As Integer) As Boolean
        Try
            ...
            Return True
        Catch ex As Exception
            QM.Errorlog("QM.HostWebcam.CheckVideoCompressors : " & ex.Message)
            Return False
        End Try
    End Function
        ...
        Try
            ...
            Else
                If Not HostCapture.Cued Then
                    Dim tempfile As String = (Application.StartupPath & "\Temp\" & QNo & "A.avi")
            ...
            End If
        Catch ex As Exception
            QM.Errorlog("HostWebcam.HostCue : Exception : " & ex.Message & " HostCapture.Stopped: " & HostCapture.Stopped.ToString & " HostCapture.Cued:" & HostCapture.Cued.ToString)
            Return False
        End Try
    End Function
    ''' <summary>
