...
Public Class GuestWebcam
    ...
    Public Function InitializeGuestWebcam(ByVal InputDeviceIndex As Integer, ByVal Qid As String) As Boolean
        ...
        Catch ex As Exception
            QM.Errorlog("QM.GuestWebcam.InitializeHostWebcam : Exception : " & ex.Message & " GuestCapture.Stopped :" & GuestCapture.Stopped)
            CheckGuest = False
            Return False
        End Try
    End Function
    ...
    Private Function CheckVideoCompressors(ByVal InputDeviceIndex As Integer) As Boolean
        Try
            ...
            Return True
        Catch ex As Exception
            QM.Errorlog("QM.GuestWebcam.CheckVideoCompressors : " & ex.Message)
            Return False
        End Try
        ...
        Try
            ...
            Else
                If Not GuestCapture.Cued Then
                    Dim tempfile As String = (Application.StartupPath & "\Temp\" & Qid & "B.avi")
            ...
            End If
        Catch ex As Exception
            QM.Errorlog("QM.GuestWebcam.GuestCue : Exception : " & ex.Message & " GuestCapture.Stopped: " & GuestCapture.Stopped.ToString & " GuestCapture.Cued:" & GuestCapture.Cued.ToString)
            Return False
        End Try
    End Function
    ''' <summary>
