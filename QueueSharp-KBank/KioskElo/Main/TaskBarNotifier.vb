...
#Region "Protected Members"
    ...
    Protected _colTextNormal As Color = Color.Navy
    Protected _colTextHover As Color = Color.Navy
    Protected _fntTitleNormal As Font = New Font("Tahoma", 20, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTitleHover As Font = New Font("Tahoma", 20, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTextNormal As Font = New Font("Tahoma", 20, FontStyle.Bold, GraphicsUnit.Pixel)
    Protected _fntTextHover As Font = New Font("Tahoma", 20, FontStyle.Bold, GraphicsUnit.Pixel)
    ...
    Public Shadows Sub Show(ByVal strTitle As String, ByVal strContent As String, _
        ...
        Select Case Me._eWindowState
            ...
            Case TaskbarStates.Hidden
                ...
                SetBounds(Me._rectWorkArea.Right - Me._bmpBackground.Width - 1, _
...
#Region "OnTimer Event Handler"
    ...
    Protected Sub OnTimer(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Select Case Me._eWindowState
            ...
            Case TaskbarStates.Appearing
                If _Hiegh < 40 Then
                    SetBounds(Left, Top - Me._iIncrementShow, Width, Height + Me._iIncrementShow + 183)
                    _Hiegh = _Hiegh + 1
                Else
                    Me._tmrAnimation.Stop()
                    Height = Me._bmpBackground.Height
...
#End Region
    ...
    Private Sub InitializeComponent()
        ...
        'TaskBarNotifier
        '
        Me.ClientSize = New System.Drawing.Size(248, 185)
