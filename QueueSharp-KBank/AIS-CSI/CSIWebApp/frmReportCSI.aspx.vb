...
Partial Class CSIWebApp_frmReportCSI
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        If txtDateFrom.DateValue.Year <> 1 Then
            para += "&DateFrom=" & txtDateFrom.DateValue.ToString("yyyy-MM-dd", New Globalization.CultureInfo("th-TH"))
        End If
        If txtDateTo.DateValue.Year <> 1 Then
            para += "&DateTo=" & txtDateTo.DateValue.ToString("yyyy-MM-dd", New Globalization.CultureInfo("th-TH"))
        End If
