...
Partial Class frmLogin
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        If txtUsername.Text.ToUpper <> "ADMIN" Then
            Try
                ...
                lPara = eng.CSIGetLDAP(txtUsername.Text.Trim, txtPassword.Text.Trim)
    ...
    Private Sub CreateUserProfile(ByVal UserName As String)
        ...
        Dim eng As New Engine.Common.LoginENG
        eng.SaveLoginHistory(UserName, Request, "QisCSI")
        ...
        Dim ck As New System.Web.HttpCookie(".AIS-CSI")
        ck.Value = FormsAuthentication.Encrypt(fat)
        ck.Expires = fat.Expiration
        HttpContext.Current.Response.Cookies.Add(ck)
        Response.Redirect("CSIWebApp/frmWelcomePage.aspx")
    End Sub
End Class
