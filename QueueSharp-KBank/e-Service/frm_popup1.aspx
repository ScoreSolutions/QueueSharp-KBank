<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frm_popup1.aspx.vb" Inherits="frm_popup1" MasterPageFile="~/e_Service_MasterPage.master"  %>
            ...
            <table style="width:619px;" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td  style="width:300px; height:200px;  vertical-align:top;">
                        <table style="width:619px;" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="text-align:center; height:30px;"  class="label_red" >
                                    <asp:Label ID="lbl_message1" runat="server" ></asp:Label>
                                </td>
                               
                            </tr>
                            <tr>
                                <td style="text-align:center; height:50px; vertical-align:middle;"  class="label_green"  >
                            ...
                            <tr>
                                <td style="text-align:center; height:30px; vertical-align:middle;" class="label_green" >
                                    <asp:Label ID="lbl_message5" runat="server" ForeColor="Black" ></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align:center; height:30px; vertical-align:middle;">
                                    <asp:ImageButton ID="img_close" runat="server" onmouseover="mouseOverImage()" 
                                        onmouseout="mouseOutImage()" style="height: 30px" />
                                </td>
                            </tr>
                        </table>
                    </td>
